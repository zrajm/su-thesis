...
\suset[swedish]{subtitle}{För användning med {\rmfamily\LaTeX} och Overleaf}
\suset[english]{title}{Thesis Template for Stockholm University}
\suset[english]{subtitle}{For Use with {\rmfamily\LaTex} and Overleaf}
...
\input{su-thesis-2-anvandning.tex}
\clearpage

\input{su-thesis-3-uppsatsstruktur.tex}
\clearpage
