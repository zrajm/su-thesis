...
\suset[swedish]{keywords}{
  ...
  kandidatuppsat, masteruppsats, uppsatsskrivande
}
...
\suset[english]{keywords}{
  ...
  thesis, master's thesis, thesis writing
}
...
\include{su-thesis-1-utseende}
\include{su-thesis-2-latex}
\include{su-thesis-3-mallen}
\include{su-thesis-4-uppsatsstruktur}
